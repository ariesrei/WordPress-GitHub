...
NOTE: This version of the CSS API is deprecated! The new version is part
of the Skin API and can be accessed via $this->css_tools from within the
Skin object.
*/
			...
			'font' => array(
				...
				'fields' => array(
					...
					'line-height' => array(
						...
						'tooltip' => sprintf(__('You can specify a line height directly, or you can allow the Thesis typography %1$s to generate your line heights according to <a href="%2$s" target="_blank" rel="noopener">Golden Ratio Typography</a>.', 'thesis'), $thesis->api->base['api'], esc_url('https://grtcalculator.com/'))),
					'font-weight' => array(
						'type' => 'select',
