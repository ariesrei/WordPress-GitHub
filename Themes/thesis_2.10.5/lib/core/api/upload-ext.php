...
class thesis_uploader extends WP_Upgrader {
	...
	public function fs_connect($directories = array(), $allow_relaxed_file_ownership = false) {
		...
		$fs = version_compare(phpversion(), '7.2', '>=') ?
			function($url, $e, $con) { return request_filesystem_credentials($url, '', $e, $con); } :
			create_function('$url, $e, $con', 'return request_filesystem_credentials($url, "", $e, $con);');
