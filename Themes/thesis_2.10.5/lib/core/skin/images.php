...
class thesis_images {
	...
	public function css() {
		echo
			...
			"#images { float:left; clear: both; padding: 13px 24px; background: #fff; box-shadow: 0 0 6px rgba(0,0,0,0.3); font-family: system-ui, BlinkMacSystemFont, \"Segoe UI\", Segoe, \"Helvetica Neue\", Tahoma, sans-serif; }\n",
			"#images table { border-collapse: collapse; border-spacing: 0; }\n",
			"th { font: bold 18px/26px system-ui, BlinkMacSystemFont, \"Segoe UI\", Segoe, \"Helvetica Neue\", Tahoma, sans-serif; }\n",
