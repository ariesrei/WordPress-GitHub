...
class thesis_dashboard_rss {
	...
	function add() {
		add_meta_box('thesis_news_widget', __('The latest from the DIYthemes Blog', 'thesis'), array($this, 'widget'), 'dashboard', 'normal', 'high');
	}
	...
	function widget() {
		...
		if (!empty($rss_items)) {
			...
			$items .= "\t\t<li><a href=\"$this->feed\">". __('Check out the DIYthemes blog!', 'thesis'). "</a></li>\n";
		echo
