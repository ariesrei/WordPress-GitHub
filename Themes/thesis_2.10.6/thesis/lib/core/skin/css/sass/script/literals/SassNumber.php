...
class SassNumber extends SassLiteral
{
  ...
  private static $validUnits = array(
    'vmin', 'vmax', 'ch', 'vh', 'vw', 'in', 'cm', 'mm', 'pc', 'pt', 'em', 'rem', 'ex', 'px', '%', 's', 'ms', 'deg', 'fr'
  );
  ...
  public function toString()
  {
    ...
    return ($this->units == 'px' ? round($this->value, self::PRECISION) : str_replace(',', '.', round($this->value, self::PRECISION))) . $this->units;
  }
