...
class thesis_title_tag extends thesis_box {
	...
	protected function post_meta() {
		...
		return empty($this->wp) ? array(
			'title' => $this->title,
			'cpt' => apply_filters("{$this->_class}_post_meta_cpt", array('post', 'page')),
			'fields' => array(
				'title' => array(
					'type' => 'text',
					'width' => 'full',
...
class thesis_post_content extends thesis_box {
	...
	protected function post_meta() {
		return array(
			'title' => $this->custom,
			'cpt' => apply_filters("{$this->_class}_post_meta_cpt", array('post')),
			'fields' => array(
				'read_more' => array(
					'type' => 'text',
					'width' => 'medium',
...
class thesis_modular_content extends thesis_box {
	...
	protected function construct() {
		global $thesis;
		$this->convert_once();
		// Custom post meta initiation sequence
