...
class thesis_css_variables {
	...
	private function form($id) {
		...
		return
			...
			"\t\t<button class=\"cancel_options\" data-style=\"button\">". $thesis->api->efn($thesis->api->strings['cancel']). "</button>\n".
			"\t\t<button class=\"save_options\" data-style=\"button save\">". $thesis->api->efn($thesis->api->strings['save']). "</button>\n".
			"\t\t<h4>$title</h4>\n".
			"\t</div>\n".
			"\t<div class=\"t_popup_body\">\n".
			$form['output'].
			"\t\t<div class=\"options_controls\">\n".
			"\t\t\t<button class=\"delete_options\" data-style=\"button delete\">". $thesis->api->efn($thesis->api->strings['delete']). "</button>\n".
			"\t\t</div>\n".
			"\t</div>\n".
